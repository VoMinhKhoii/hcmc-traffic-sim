...
// Mid-block pedestrian crossing on the I2–I4 diagonal (520 m).
// Positioned at 260 m from I2 (midpoint of the link), which is well clear of
// crossing B (110 m from I2) and gives pedestrians the widest gap from either
// intersection. The protecting intersection is I2 (phase B serves the S approach
// toward I4; when phase B is green, vehicles flow across this point).
export const MID_BLOCK_PEDS = {
  'I2-I4-mid': {
    linkId: 'I2-I4',
    fromNode: 'I2',
    distFromI2: 260,       // metres from I2 end
    frac: 260 / 520,       // fractional position along link (0=I2, 1=I4)
    protectingNode: 'I2',
    protectingApproach: 'S',   // I2's S approach feeds vehicles toward I4
    protectingPhase: 'B',      // phase B serves N+S at I2
    walkDuration: 13,          // s — user requirement
    clearDuration: 2,          // s post-WALK all-clear
    nearVehicleMetres: 50,     // night-mode: gap check within this distance
    trainGuardSecs: 15,        // s: don't start WALK if train ETA ≤ this (13+2=15)
    safetyLagSecs: 1,          // s after gates proved-down before WALK fires
  },
};
