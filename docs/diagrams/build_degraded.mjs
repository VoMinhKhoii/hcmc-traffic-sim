...
const proc = pool("deg", "Losing central — the corridor degrades, it does not stop", {
  ...
  serviceTask("t1", { lane: 0, col: 1, label: "Publish plan\nsplits · offsets" }),
  gateway("g1", { lane: 0, col: 2, label: "Reachable?" }),
  serviceTask("t2", { lane: 1, col: 3, label: "Apply plan —\nstay coordinated" }),
  task("tr", { lane: 3, col: 4, label: "Green wave holds\nacross I3 → I5" }),
  end("e2",  { lane: 3, col: 5, label: "Coordinated service" }),
  serviceTask("t4", { lane: 1, col: 4, label: "Autonomous —\nhold last known plan" }),
  serviceTask("t5", { lane: 2, col: 5, label: "Buffer outgoing\nmessages" }),
  task("t6", { lane: 1, col: 6, label: "Signals keep cycling\nno blackout" }),
  gateway("g2", { lane: 2, col: 7, label: "Back up?" }),
  serviceTask("t7", { lane: 2, col: 8, label: "Flush buffer\non reconnect" }),
  serviceTask("t8", { lane: 0, col: 9, label: "Resync state" }),
